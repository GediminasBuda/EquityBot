...
def _ticker_search(query: str) -> list[tuple[str, str]]:
    ...
    _hk_direct = _re_pf.match(r'^0*(\d{1,5})(\.HK)?$', q.strip().upper())
    if _hk_direct:
        ...
        if _hk_ticker not in seen:
            ...
            _hk_label = (
                ...
                if _hk_name else
                f"🇭🇰 {_hk_ticker}  · HKEX (enter to add)"
            )
            out.append((_hk_label, _hk_ticker))
...
st.iframe(
    ...
    (function() {
      ...
      var SB_CSS = (
        ...
        '[class*="control"],[class*="-control"]{background:#000!important;border:none!important;' +
        'box-shadow:inset 0 0 0 2px #8B0000!important;' +
        'border-radius:0!important;min-height:38px!important}' +
        ...
        '{display:none!important}' +
        '[class*="menu"]{background:#000!important;border:2px solid #8B0000!important;border-radius:0!important}' +
